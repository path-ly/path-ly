...
export const metadata: Metadata = {
  ...
  description:
    "מאיה פלטי, פסיכולוגית חינוכית מומחית עם 20 שנות ניסיון. הדרכת הורים בגישה חומלת ומבוססת מחקר לילדים בגיל 3-15. ארגז הכלים ההורי — כלים פרקטיים להורות מדויקת.",
  keywords: [
    "פסיכולוגית חינוכית",
    "הדרכת הורים",
    "ארגז כלים הורי",
  ...
  openGraph: {
    ...
    description:
      "הדרכת הורים מבוססת מחקר לילדים בגיל 3-15. ארגז הכלים ההורי — 10 כלים פרקטיים להורות חומלת ומדויקת.",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "ארגז הכלים ההורי — 10 כלים מבוססי מחקר להורות חומלת לילדים בגיל 3-15.",
    ...
    "@graph": [
      {
        ...
        description:
          "הדרכת הורים מבוססת מחקר לילדים בגיל 3-15. פסיכולוגית חינוכית מומחית עם 20 שנות ניסיון.",
        priceRange: "$$",
        address: [
          {
            "@type": "PostalAddress",
