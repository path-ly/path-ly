...
export const TOOLS: Tool[] = [
  {
    ...
    tips: [
      ...
      "זכרו את משל הבור ונסו ״הצהרת חמלה״ למשל: ״זה קשה. כל הורה חווה את זה. אני יכול/ה להיות עדין/ה עם עצמי עכשיו״ או ״זה שלא השגתי עדיין את התוצאה הרצויה לא אומר שאני לא מתקדם״ או כל נוסח שמתאים לכם.",
